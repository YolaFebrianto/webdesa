...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <a class="btn btn-success">Data Pengaduan</a>
        </p>
        <div id="w0" class="grid-view">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php foreach ($pengaduan->result() as $key => $value) { ?>
                    <tr data-key="1">
                        <td><?= $value->id ?></td>
                        <td><?= $value->nama_pelapor ?></td>
                        <td><?= $value->alamat ?></td>
                        <td><?= $value->tgl ?></td>
                        <td><?= substr(strip_tags($value->isi), 0, 10) . '...' ?></td>
                        <!--<td><?//= $value->gambar ?></td>-->
                        <td><?= $value->keterangan ?></td>
                        <td>
                            <i class="far fa-edit"></i><a
                                href="<?php echo base_url('admin/lihat_pengaduan/') . $value->id ?>">Lihat</a>
                            |
                            <i class=" fas fa-trash-alt"></i><a
                                href="<?php echo base_url('admin/hapus_pengaduan/') . $value->id ?>">Hapus</a>
                        </td>
                        <?php } ?>
